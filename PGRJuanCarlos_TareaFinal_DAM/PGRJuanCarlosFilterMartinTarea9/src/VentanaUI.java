...
public class VentanaUI extends javax.swing.JFrame {
    ...
    private void modificarBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarBtActionPerformed
        ...
        if (msg == null) {
            //llamada al metodo ConsultarCdogioBaseDatos
            Departamento depart = baseDatos.consultarCodigoBaseDatos(Integer.parseInt(this.codigoTf.getText()));
            ...
            if (this.nombreTf.getText().isEmpty() || this.nombreTf.getText().isBlank()) {
                this.nombreTf.setText(depart.getNombre());
            }
            ...
            if (this.idlocalizacionTf.getText().isEmpty() || this.idlocalizacionTf.getText().isBlank()) {
                this.idlocalizacionTf.setText(String.valueOf(depart.getIdLocalizacion()));
            }
            ...
            if (this.idmanagerTf.getText().isEmpty() || this.idmanagerTf.getText().isBlank()) {
                this.idmanagerTf.setText(String.valueOf(depart.getIdManager()));
            }
    ...
    private void borrarBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarBtActionPerformed
        ...
        if (msg == null) {
            ...
            Departamento depart = baseDatos.Borrar(Integer.parseInt(this.codigoTf.getText()));
            
            //Se introduce los campos codigo, nombre, localizacion y manager en sus textField correspondiente
            this.codigoTf.setText(String.valueOf(depart.getCodigo()));
            this.nombreTf.setText((depart.getNombre()));
            this.idlocalizacionTf.setText(String.valueOf(depart.getIdLocalizacion()));
            this.idmanagerTf.setText(String.valueOf(depart.getIdManager()));
    ...
    private void mostrar() {
        ...
        for (int i = 0; i < arrayDeparts.size(); i++) {
            ...
            String[] datosTablaDepartamento = {
                Integer.toString(arrayDeparts.get(i).getCodigo()),
                arrayDeparts.get(i).getNombre(), 
                Integer.toString(arrayDeparts.get(i).getIdLocalizacion()),
                Integer.toString(arrayDeparts.get(i).getIdManager())
            };
            
            //Se añade cada objeto en una linea nueva del array datosTablaDepartamento
            dm.addRow(datosTablaDepartamento);
        }
    }
